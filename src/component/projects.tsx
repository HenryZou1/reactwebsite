...
const Projects: React.FC = () => {
  ...
  const projects: VideoProject[] = [
    ...
    },
    {
      ...
      description:
        "Fullstack application with React, Material UI, Express, and Redis. Scrapes Reddit and Twitter for company mentions using background workers and cron jobs.",
    ...
    },
    {
      ...
      description:
        "MATLAB program demonstrating JPEG compression using discrete cosine transformation on 8x8 image blocks with reconstruction visualization.",
    ...
    },
    {
      ...
      description:
        "Python torrent-like application using TCP sockets for local area network file sharing with multi-client support and multiprocessing.",
    ...
    },
    {
      ...
      title: "VGA Driver",
      description:
        "VGA driver for Xilinx Spartan-3E FPGA enabling Pong game display at 60Hz refresh rate with 640x480 resolution using custom clock division.",
    ...
    },
    {
      ...
      title: "Jarknoid",
      description:
        "Brick breaker game built with Java Swing featuring custom game engine, physics system, animations, and score tracking.",
      thumbnailUrl: "https://img.youtube.com/vi/1_43MkpMEbk/maxresdefault.jpg",
      videoId: "1_43MkpMEbk",
    },
    {
      id: "8",
      ...
      description:
        "Computer vision system using Raspberry Pi 4 and OpenCV for real-time ping pong ball detection through color matching and contour analysis.",
